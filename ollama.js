    ...
    dbOpen.addEventListener("upgradeneeded", (e) => {
        ...
        if (e.oldVersion <= 1) {
            ...
            transaction.addEventListener('complete', ()=> {
                ...
                alert("Due to the database upgrade, I recommend you delete all old chats, as from now on chats have the model they are begun with stored to avoid issues with switching models with the same context");
            });
        }
    });
